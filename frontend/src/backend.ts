...
export class Backend implements backendInterface {
    ...
    async add(arg0: bigint, arg1: bigint): Promise<{
        result: bigint;
        expression: string;
    }> {
    ...
    async divide(arg0: bigint, arg1: bigint): Promise<{
        result: bigint;
        expression: string;
    }> {
        if (this.processError) {
    ...
    async multiply(arg0: bigint, arg1: bigint): Promise<{
        result: bigint;
        expression: string;
    }> {
        if (this.processError) {
    ...
    async subtract(arg0: bigint, arg1: bigint): Promise<{
        result: bigint;
        expression: string;
    }> {
        if (this.processError) {
